...
export const AGENT_ACTION_REGISTRY: Record<AgentActionType, ActionMeta> = {
  ...
  readSafetyNote: { label: "Read safety note", description: "Read Sema's safety and limitations note.", riskLevel: "read_only", requiresPermission: false },
  ...
  exportPacketPdf: { label: "Export PDF", description: "Open the browser print/export flow for the evidence packet.", riskLevel: "high_impact", requiresPermission: true },
